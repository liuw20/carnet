...
def args_parser():
    ...
    parser.add_argument('--cuda_device', type=int, default=9, help="cuda_device")
    ...
    parser.add_argument('--path', type=str, default='/Users/julyc/PycharmProjects/parking_lot_occupancy_detection/weights/carnet_40_0.1.pth', help='trained model path')
    # parser.add_argument('--train_img', type=str, default='/home/zengweijia/.jupyter/cnrpark/PATCHES',
    #                     help="path to training set images")
    # parser.add_argument('--train_lab', type=str, default='/home/zengweijia/.jupyter/cnrpark/splits/CNRPark-EXT/train.txt',
    ...
    # parser.add_argument('--test_lab', type=str, default='/home/zengweijia/.jupyter/cnrpark/splits/CNRPark-EXT/val.txt',
    ...
    parser.add_argument('--split_path', type=str, default='/Users/julyc/PycharmProjects/parking_lot_occupancy_detection/data/carnet',
                        help="path to training set labels")
